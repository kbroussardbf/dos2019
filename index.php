...
<h1>Welcome<?php if ($USER) { echo " ".$USER; } else { echo " Workshop Participant"; } ?>!</h1>
  ...
  SO INSTEAD I've got a git project for you to download or git clone, <br/>
    (unzip into /var/www/html and rename to dos2019yyz if needed), <br/>
    and then chmod +x /var/www/html/dos2019yyz/install.sh<br/>
    and run ./var/www/html/dos2019yyz/install.sh and you should be all ready to go!</p>
  ...
  <p>GIT CLONE: cd /var/www/html && git clone https://github.com/kbroussardbf/dos2019yyz.git
</div>
</body>
</html>
